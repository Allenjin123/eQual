...
entry:
  ...
  %0 = tail call i32 @__cxa_atexit(ptr nonnull @_ZNSt3__18ios_base4InitD1Ev, ptr nonnull @_ZL9_Ios_init.10, ptr nonnull @__dso_handle) #28
  ret void
}
...
entry:
  %call.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwj(i32 noundef 16) #32, !noalias !240
...
lpad.i:                                           ; preds = %entry
  %0 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i, i32 noundef 16) #29, !noalias !240
  resume { ptr, i32 } %0
...
entry:
  %call.i = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwj(i32 noundef 16) #32, !noalias !249
...
lpad.i:                                           ; preds = %entry
  %0 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i, i32 noundef 16) #29, !noalias !249
  resume { ptr, i32 } %0
...
entry:
  tail call void @_ZNSt3__120__throw_length_errorB8ne190000EPKc(ptr noundef nonnull @.str.25.21) #31
  unreachable
}
...
lpad.i.i:                                         ; preds = %call.i.i.noexc
  %1 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i.i67, i32 noundef 16) #29, !noalias !279
...
lpad.i.i73:                                       ; preds = %call.i.i.noexc74
  %3 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i.i75, i32 noundef 16) #29, !noalias !284
  br label %_ZNSt3__110unique_ptrI10AllocationNS_14default_deleteIS1_EEED2B8ne190000Ev.exit110
...
entry:
  ...
  %0 = tail call i32 @__cxa_atexit(ptr nonnull @_ZNSt3__18ios_base4InitD1Ev, ptr nonnull @_ZL9_Ios_init.30, ptr nonnull @__dso_handle) #28
  ret void
}
...
if.end:                                           ; preds = %_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEED2Ev.exit, %entry
  %call.i = call noalias noundef nonnull dereferenceable(40) ptr @_Znwj(i32 noundef 40) #32, !noalias !343
...
lpad.i:                                           ; preds = %if.end
  %4 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvj(ptr noundef nonnull %call.i, i32 noundef 40) #29, !noalias !343
  br label %common.resume
...
if.end10:                                         ; preds = %_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEED2Ev.exit35, %_ZNSt3__110unique_ptrI8VtcmPoolNS_14default_deleteIS1_EEED2B8ne190000Ev.exit
  ...
  %call.i44 = call noalias noundef nonnull dereferenceable(20) ptr @_Znwj(i32 noundef 20) #32, !noalias !346
...
; Function Attrs: inlinehint mustprogress
define internal void @_ZL13_HAP_debug_v2iPKciS0_z.37(i32 %level, ptr readnone captures(none) %file, i32 %line, ptr readnone captures(none) %format, ...) unnamed_addr #8 {
entry:
  %buf = alloca [256 x i8], align 8
  %args = alloca ptr, align 4
  call void @llvm.lifetime.start.p0(ptr %buf)
...
entry:
  ...
  %call.i = tail call noalias noundef nonnull dereferenceable(36) ptr @_Znwj(i32 noundef 36) #32, !noalias !359
...
lpad.i:                                           ; preds = %entry
  %3 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i, i32 noundef 36) #29, !noalias !359
  br label %common.resume
...
if.end23:                                         ; preds = %_ZNSt3__116__constrain_hashB8ne190000Ejj.exit132, %for.inc, %for.cond.preheader, %_ZNSt3__116__constrain_hashB8ne190000Ejj.exit, %_ZNKSt3__14hashIPvEclB8ne190000ES1_.exit
  ...
  %call.i5.i.i.i.i = call noalias noundef nonnull dereferenceable(16) ptr @_Znwj(i32 noundef 16) #32, !noalias !371
...
entry:
  ...
  %call.i = tail call noalias noundef nonnull dereferenceable(36) ptr @_Znwj(i32 noundef 36) #32, !noalias !380
...
lpad.i:                                           ; preds = %entry
  %4 = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvj(ptr noundef nonnull %call.i, i32 noundef 36) #29, !noalias !380
  br label %common.resume
